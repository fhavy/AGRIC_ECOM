...
<table>
     ...
     <div class="morefooter">
          ...
          <div class="call">
               ...
               <a href="#" style="color:black;">+234 80927868091</a>
          </div>
     ...
     <div class="instaid">
          ...
          <div class="gmailid">
               <a href="#" class="hypher" style="color:black;">fhavyghabs@gmail.com</a>
          </div>

     </div>
     <div class="copy">
          <h5 style="test-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2023 by www.AgroCraft.com</h5>
     </div>
